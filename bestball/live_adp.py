...
as ``data/dk_best_ball_adp_2025.csv`` and load it here. This is real DK
Best Ball ADP -- not the points-above-replacement proxy in ``players.py`` --
covering the 2025 season draft class (it includes 2025 rookies).
...
DEFAULT_PATH = Path(__file__).resolve().parent.parent / "data" / "dk_best_ball_adp_2025.csv"
